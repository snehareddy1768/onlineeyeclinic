...
public class SpectaclesServiceTest {
	...
	@Test
	public void updateDoctorTest() throws SpectaclesIdNotFoundException {
	...
	@Test
	public void deleteDoctorTest() throws SpectaclesIdNotFoundException {
		Spectacles specs= new Spectacles(01,"car","rect",540.0);
		Integer spectaclesId = specs.getSpectaclesId();
	...
	@Test
	public void viewDoctorTest() throws SpectaclesIdNotFoundException {
		Spectacles specs= new Spectacles(01,"car","rect",540.0);
		Integer spectaclesId = specs.getSpectaclesId();
	...
	@Test
	public void viewSpectaclesListTest() {
